...
public interface FeignReservationProxy {
    ...
    boolean checkIfReservationExist(@PathVariable("customerId") Integer customerId, @PathVariable("bookId") Integer bookId);
    ...
    void updateReservation(@PathVariable("bookId") Integer bookId);

    @PutMapping("/api/reservations/book/{bookId}/refresh")
    void updateDateReservation(@PathVariable("bookId") Integer bookId);
